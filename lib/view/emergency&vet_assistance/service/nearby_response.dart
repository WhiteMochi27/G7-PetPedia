...
// Add this new class to handle detailed operating hours
class OpeningHours {
  bool? openNow;
  List<Period>? periods;
  ...
  // Format time string from "0900" to "9:00 AM"
...
class Period {
  ...
  // Get formatted day and time range
  String getFormattedHours() {
    ...
    final day = dayNames[open!.day ?? 0];
    final openTime = OpeningHours.formatTime(open!.time ?? "0000");
    final closeTime = OpeningHours.formatTime(close!.time ?? "0000");
